...
def handle_login():
    ...
    if user_data:
        ...
        response = make_response(redirect("http://localhost:8080/ProyectoMaven/animation.jsp"))
        response.set_cookie(
            "token",
            token,
...
######################################################################################
# Endpoint para actualizar los datos del perfil y contraseña del usuario autenticado #
######################################################################################
...
###########################################################################
# Endpoint para eliminar la cuenta del usuario autenticado mediante su ID #
###########################################################################
...
#############################################################
# Endpoint que obtiene el nombre de usuario a partir del ID #
#############################################################
...
####################################################################
# Endpoint que devuelve la lista de usuarios activos en el sistema #
####################################################################
...
########################################################################
# Endpoint que devuelve los datos detallados de un usuario según su ID #
########################################################################
...
###########################################################################################
# Endpoint que indica si un usuario está conectado o no, en base a si tiene cookie activa #
###########################################################################################
