...
<%@ page import="io.jsonwebtoken.SignatureException" %>

<%
    // Clave secreta para validar el token
    String secretKey = "clave_super_secreta";  // Asegúrate de usar la misma clave secreta
    ...
    try {
        ...
        Claims claims = Jwts.parser()
            .setSigningKey(secretKey.getBytes())  // Usamos la clave secreta para verificar la firma
            .parseClaimsJws(token)  // Parseamos el token JWT
            .getBody();
        
        userId = claims.getSubject();  // Obtener el ID del usuario desde el token
