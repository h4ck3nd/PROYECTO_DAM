...
<body>
    ...
    <div class="nav-container">
        <nav class="nav-menu">
            ...
            <a href="<%= request.getContextPath() %>/ovalabs/ovalabs.jsp?page=0"><img src="<%= request.getContextPath() %>/img/ovalabs.png" class="img-ovalabs" width="20px" height="20px"> OVAlabs</a>
    ...
    <div class="pagination">
        <div class="google-logo">H<span class="style-letters-hackend">a</span><span>a</span><span>a</span><span>a</span><span>a</span><span>a</span>ckend</div>
        <a href="home_dockerpwned.jsp?page=0" class="page-link">1</a>
        <a href="Page1.jsp?page=1" class="page-link style-link-number">2</a>
