...
<body>
	...
	const searchResults = [
	    { url: "../labs/foro-xss.jsp?token=<%= token %>", title: "Curso de Hacking Web", description: "Conoce las bases del hacking web, los principales ataques y cómo prevenirlos.", image: "../img/xss.png", tags: ["xss", "web", "seguridad"] },
