...
<body>
    ...
    <div class="nav-container">
        <nav class="nav-menu">
            ...
            <a href="<%= request.getContextPath() %>/dockerpwned/dockerpwned.jsp?page=0"><img src="<%= request.getContextPath() %>/img/dockerpwned.png" class="img-dockerpwned" width="25px" height="15px"> DockerPwned</a>
