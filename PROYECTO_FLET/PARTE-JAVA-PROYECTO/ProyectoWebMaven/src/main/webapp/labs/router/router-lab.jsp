...
<%
    ...
    int labId = LaboratorioDAO.obtenerIdLaboratorioRouterOS();
    String mensaje = "";
...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="ROUTER OS LAB"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/labs/router/router-lab.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
		<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/logo-test-36-update.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
      <h2 class="typewriter" data-text="ROUTER OS LAB: HACKING WEB"></h2>
      <p><strong>Autor:</strong> D1se0</p>
      <p><strong>Descripción:</strong> Explota una vulnerabilidad utilizando la famosa herramienta llamada BurpSuite.</p>
      <p><strong>Fecha de creación:</strong> 01/05/2025</p>
  ...
  <section class="download-section">
  	<h3>============================LABORATORIO============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.location.href='<%= request.getContextPath() %>/labs/router/login.jsp'">⬇️ Ir a RouterOS (LAB)</button>
    <br><br>
    <h3>===================================================================</h3>
  </section>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/labs/router/router-lab.jsp"; // Redirigimos
    }
