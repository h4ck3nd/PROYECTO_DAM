...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="HACKING COMMUNITY LAB"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/labs/hacking_community/hacking_community-lab.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
		<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/logo-test-4-update.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
  ...
  <section class="download-section">
  	<h3>============================LABORATORIO============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.location.href='<%= request.getContextPath() %>/labs/hacking_community/hacking_community.jsp'">⬇️ Ir a Hacking Community (LAB)</button>
    <br><br>
    <h3>===================================================================</h3>
  </section>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/labs/hacking_community/hacking_community-lab.jsp"; // Redirigimos
    }
