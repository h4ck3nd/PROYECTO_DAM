...
<%
    ...
    int labId = LaboratorioDAO.obtenerIdLaboratorioRetroGame();
    String mensaje = "";
...
<head>
  ...
  <title>HACKING COMMUNITY LAB</title>
...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="RETRO GAME LAB"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/labs/retroGame/retroGame-lab.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
		<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/logo-test-21-update.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
      <h2 class="typewriter" data-text="RETRO GAME LAB: HACKING WEB"></h2>
  ...
  <section class="download-section">
  	<h3>============================LABORATORIO============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.location.href='<%= request.getContextPath() %>/labs/retroGame/retroGame-login.jsp'">⬇️ Ir a Retro Game (LAB)</button>
    <br><br>
    <h3>===================================================================</h3>
  </section>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/labs/retroGame/retroGame-lab.jsp"; // Redirigimos
    }
