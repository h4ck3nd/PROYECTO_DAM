...
<main>
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/logo-test-2-update.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
  ...
  <section class="download-section">
  	<h3>============================LABORATORIO============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.location.href='<%= request.getContextPath() %>/labs/foro-xss.jsp'">⬇️ Ir a Foro XSS (LAB)</button>
    <br><br>
    <h3>===================================================================</h3>
  </section>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/labs/foro-xss-lab.jsp"; // Redirigimos
    }
