...
<%
    ...
    int labId = LaboratorioDAO.obtenerIdLaboratorioWhatsappFake();
    String mensaje = "";
...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="WHATSAPP FAKE LAB"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/labs/whatsapp_fake/whatsapp_fake_lab.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
		<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/logo-test-35-update.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
      <h2 class="typewriter" data-text="WHATSAPP FAKE LAB: HACKING WEB"></h2>
      <p><strong>Autor:</strong> D1se0</p>
      <p><strong>Descripción:</strong> Comparte tus conocimientos sobre la vulnerabilidad que salio hace un tiempo relacionada con WhatsApp.</p>
      <p><strong>Fecha de creación:</strong> 30/04/2025</p>
  ...
  <section class="download-section">
  	<h3>============================LABORATORIO============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.location.href='<%= request.getContextPath() %>/labs/whatsapp_fake/contactos.jsp'">⬇️ Ir a WhatsApp Fake (LAB)</button>
    <br><br>
    <h3>===================================================================</h3>
  </section>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/labs/whatsapp_fake/whatsapp_fake_lab.jsp"; // Redirigimos
    }
