...
<body>
	...
	const searchResults = [
		...
		{ url: "../labs/hackertool.jsp", title: "TOOLKIT HACKING", description: "Conoce las herramientas mas famosas que utilizan los hackers en Hacking Web.", image: "../img/logo-test-21-update.png", tags: ["tools", "toolkit", "hacking tools", "hacking web"] },
