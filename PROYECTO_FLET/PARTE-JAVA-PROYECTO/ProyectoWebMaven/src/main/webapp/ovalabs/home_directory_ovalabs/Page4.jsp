...
<body>
    ...
    <div class="pagination">
        <div class="google-logo">O<span>v</span><span>v</span><span>v</span><span class="style-letters-hackend">v</span><span>v</span><span>v</span>alabs</div>
	...
	function nextPage() {
		...
		// Si estamos en Page4.jsp, redirige a home.jsp
			...
			window.location.href = `home_ovalabs.jsp?page=0`;
		}
	}
