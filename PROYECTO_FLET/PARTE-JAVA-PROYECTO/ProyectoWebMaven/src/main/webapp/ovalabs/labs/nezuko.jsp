...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="NEZUKO MACHINE"></h1>
  </div>
...
<main>
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      <h2 class="typewriter" data-text="NEZUKO MACHINE: OVALABS"></h2>
      <p><strong>Autor:</strong> D1se0 & Manu</p>
      <p><strong>Descripción:</strong> Domina desafíos CTF con fuerza bruta, explotación de Samba, análisis de permisos SUID y dos formas de escalada de privilegios.</p>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/1Nf9P5rH_Hed3apSBRLMYDbRzkza7gwB7/view', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 NEZUKO Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/nezuko.jsp"; // Redirigimos
    }
