...
<head>
  ...
  <title>Rootless Lab - Máquina CTF</title>
...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="GUARDIANS OF GALAXY MACHINE"></h1>
  </div>
  <div class="window-buttons">
    <button class="minimize">🗕</button>
    <button class="maximize">🗖</button>
    <button onclick="window.location.href='<%= request.getContextPath() %>/ovalabs/home_directory_ovalabs/home_ovalabs.jsp'" class="close">✖</button>
  </div>
</header>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/ovalabs/labs/guardiansofgalaxy.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
	<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    <div class="lab-img">
      <img src="<%= request.getContextPath() %>/img/img_ovalabs/r00tless.png" alt="Máquina CTF">
    </div>
    <div class="lab-info">
      <h2 class="typewriter" data-text="GUARDIANS OF GALAXY MACHINE: OVALABS"></h2>
      <p><strong>Autor:</strong> D1se0 & Manu</p>
      <p><strong>Descripción:</strong> Aprende técnicas avanzadas de CTF como captura de peticiones con Burp Suite, reverse shell, análisis de paquetes con Wireshark y bypass de Restricted Bash.</p>
  ...
  <section class="lab-tecnica">
    ...
    <ul class="tecnica-grid">
      ...
      <li>📡 Captura de Peticiones con Burp Suite</li>
      <li>🔄 Reverse Shell</li>
      <li>📊 Análisis de Paquetes con Wireshark para Credenciales</li>
      <li>👀 Observación de Procesos para Ver Qué Root Está Ejecutando en Bucle</li>
      <li>🔒 Restricted Bash</li>
      <li>🛡️ Permisos SUID</li>
    </ul>
  </section>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/1CRK2uCWqAVKjGzsmcjiEMTzyhrnFCYt-/view?usp=sharing', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 GUARDIANS OF GALAXY Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/guardiansofgalaxy.jsp"; // Redirigimos
    }
