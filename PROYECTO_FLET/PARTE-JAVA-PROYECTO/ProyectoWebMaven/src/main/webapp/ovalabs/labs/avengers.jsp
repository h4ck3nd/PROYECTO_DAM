...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="AVENGERS MACHINE"></h1>
  </div>
...
<main>
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      <h2 class="typewriter" data-text="AVENGERS MACHINE: OVALABS"></h2>
      <p><strong>Autor:</strong> D1se0 & Manu</p>
      <p><strong>Descripción:</strong> Explora retos CTF con escaneo de puertos, interacción con servicios en Python, reverse shell y escalada de privilegios con sudo.</p>
      <p><strong>Fecha de creación:</strong> 10/02/2025</p>
      <button class="nivel-btn">Facíl</button>
    </div>
  </section>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/1ALrKezZIwTLRH3c_jnCPNVf_sp9VQ-1n/view', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 AVENGERS Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/avengers.jsp"; // Redirigimos
    }
