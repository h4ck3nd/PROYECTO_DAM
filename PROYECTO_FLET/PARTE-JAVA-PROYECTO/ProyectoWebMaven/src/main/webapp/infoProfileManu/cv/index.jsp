    ...
    $("body").terminal(function (command, term) {
        ...
        const commandsObj = {
            ...
            exit: function () {
                ...
                simulateExit(term);
                setTimeout(function () {
                    window.location = "<%= request.getContextPath() %>/infoProfileManu/index.jsp";
                }, 2000);
            }
        };
        ...
        prompt: "[[;green;]m4nu@hackend][[;blue;]:~$] ",
        greetings: `[[b;white;]This is m4nu\n\nType 'help' for a list of available commands]`,
        keydown: function (event, term) {
            if (isLoading && event.which === 68 && event.ctrlKey) {
                clearTimeout();
                isLoading = false;
                term.echo("[[b;red;]FAIL]").set_prompt("[[;green;]m4nu@hackend][[;blue;]:~$] ");
                return false;
            }
        },
