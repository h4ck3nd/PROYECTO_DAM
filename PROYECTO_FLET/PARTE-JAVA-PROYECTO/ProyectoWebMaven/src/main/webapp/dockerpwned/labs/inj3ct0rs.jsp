...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="INJ3CT0RS MACHINE"></h1>
  </div>
...
<main>
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      <h2 class="typewriter" data-text="INJ3CT0RS: DOCKERPWNED"></h2>
      <p><strong>Autor:</strong> D1se0 & Manu</p>
      <p><strong>Descripción:</strong> Domina desafíos CTF con técnicas como SQL Injection, explotación de claves id_rsa, crackeo de archivos ZIP y escalada de privilegios con sudo.</p>
  ...
  <section class="lab-tecnica">
    ...
    <ul class="tecnica-grid">
      ...
      <li>💉 SQL Injection</li>
      <li>🔑 Permisos Sudo</li>
      <li>📦 Crack de Archivos ZIP</li>
      <li>🔐 Explotación de Claves id_rsa </li>
    </ul>
  </section>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/1tAL7aa1YRoQsWdbrz1ChNA2dRASE5u_3/view?usp=sharing', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 INJ3CT0RS Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/inj3ctors.jsp"; // Redirigimos
    }
