...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="VULNVAULT MACHINE"></h1>
  </div>
...
<main>
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      <h2 class="typewriter" data-text="VULNVAULT: DOCKERPWNED"></h2>
      <p><strong>Autor:</strong> D1se0 & Manu</p>
      <p><strong>Descripción:</strong> Aprende a superar desafíos CTF con técnicas clave como enumeración, inyección de código y análisis de procesos y privilegios.</p>
  ...
  <section class="lab-tecnica">
    ...
    <ul class="tecnica-grid">
      <li>🔍 Enumeración</li>
      <li>🛠️ Inyección de codigo</li>
      <li>💻 Enumeración de Procesos y Privilegios</li>
    </ul>
  </section>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/16mDWzuXi8n_BijKp9dIWdr7OPb7LnDOy/view?usp=sharing', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 VULNVAULT Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/vulnvault.jsp"; // Redirigimos
    }
