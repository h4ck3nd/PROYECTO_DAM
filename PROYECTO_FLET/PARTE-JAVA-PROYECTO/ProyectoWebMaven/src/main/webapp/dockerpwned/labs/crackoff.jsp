...
<main>
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      ...
      <p style="text-shadow: 1px 1px 2px gray;"><strong>Descripción:</strong> Aprende a realizar un SQLi, realizar fuerza bruta, crear una tunelizacion de puertosm, etc...</p>
  ...
  <p style="text-shadow: 1px 1px 2px gray;"><strong>MD5:</strong> f596b6f9153e2d8e06a617d07ab3fd46</p> <!-- OBTENER HASH MD5 UTILIZANDO UN COMANDO EN CMD EN WINDOWS (CertUtil -hashfile C:\<PATH>\machine.ova MD5) / EN LINUX (md5sum machine.iso) -->
