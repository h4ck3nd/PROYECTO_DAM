...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="R00TLESS MACHINE"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/dockerpwned/labs/r00tless.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
	<!-- POPUP MODAL -->
  ...
  <section class="lab-intro">
    ...
    <div class="lab-info">
      ...
      <p style="text-shadow: 1px 1px 2px gray;"><strong>Autor:</strong> D1se0 & Manu</p>
      <p style="text-shadow: 1px 1px 2px gray;"><strong>Descripción:</strong> Aprende a encontrar credenciales por servidores SMB, crear diccionarios de fuerza bruta, crackeo de contraseñas, etc...</p>
  ...
  <div style="margin-left: 470px; padding-right: 50px; margin-top: -40px;">
    <p style="text-shadow: 1px 1px 2px gray;"><strong>MD5:</strong> 7ffd4f0fae8210d33376626bb992d58c</p> <!-- OBTENER HASH MD5 UTILIZANDO UN COMANDO EN CMD EN WINDOWS (CertUtil -hashfile C:\<PATH>\machine.ova MD5) / EN LINUX (md5sum machine.iso) -->
  ...
  <section class="lab-tecnica">
    ...
    <ul class="tecnica-grid">
      ...
      <li>🪪 Credenciales SMB</li>
      <li>⬆️ Subida de archivos vía SSH</li>
      <li>📄 Diccionario por Python</li>
      <li>🔨 Fuerza Bruta</li>
      <li>🕳️ Tunelización</li>
      <li>🔐 Crackeo ZIP</li>
...
<footer>
  <p>© 2025 Rootless Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/r00tless.jsp"; // Redirigimos
    }
