...
<header>
  <div class="header-left">
    <h1 class="typewriter" data-text="HACK ME DADDY MACHINE"></h1>
  </div>
...
<main>
    ...
    <div id="popupMessage" class="message-popup">
        ...
        <button class="message-popup-close-btn"><a href="<%= request.getContextPath() %>/dockerpwned/labs/hackmedaddy.jsp" style="text-decoration: none; color: white;">Cerrar</a></button>
    </div>
    <br>
	<!-- POPUP MODAL -->
  ...
  <section class="lab-tecnica">
    ...
    <ul class="tecnica-grid">
      ...
      <li>🕵️‍♂️ Escaneo de Directorios</li>
      <li>🔄 Reverse Shell</li>
      <li>🔨 Fuerza Bruta</li>
      <li>📜 Crear Diccionario para Fuerza Bruta</li>
      <li>🔑 Permisos de Sudo</li>
    </ul>
  </section>
  ...
  <section class="download-section">
  	<h3>============================DOWNLOAD============================</h3>
  	<br><br>
    <button class="download-btn" onclick="window.open('https://drive.google.com/file/d/1VCC-mMIGoh-JUgcbCnHdKTqQQXq-yxf5/view?usp=sharing', '_blank')">⬇️ Descargar Máquina</button>
    <br><br>
    <h3>================================================================</h3>
  </section>
...
<footer>
  <p>© 2025 HACK ME DADDY Labs. Todos los derechos reservados.</p>
</footer>
...
<script>
    ...
    function closePopup() {
        ...
        window.location.href = "<%= request.getContextPath() %>/dockerpwned/labs/hackmedaddy.jsp"; // Redirigimos
    }
