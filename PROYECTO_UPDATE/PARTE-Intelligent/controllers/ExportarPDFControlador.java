...
public class ExportarPDFControlador {
    ...
    public ResponseEntity<byte[]> exportarPDF(
        ...
        try (Connection conn = conexionDDBB.conectar();
             FileInputStream jasperStream = new FileInputStream("C:/Users/clipd/eclipse-workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/Hackend/vistas/reports/reportFlags.jasper")) {
