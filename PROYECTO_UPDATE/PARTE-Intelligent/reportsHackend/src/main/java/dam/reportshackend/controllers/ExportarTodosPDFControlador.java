...
public class ExportarTodosPDFControlador {
    ...
    public ResponseEntity<byte[]> exportarTodoPDF(@RequestParam("usuariosJSON") String usuariosJSON) {
        ...
        try (Connection conn = conexionDDBB.conectar();
             FileInputStream jasperStream = new FileInputStream("C:/Users/Usuario/eclipse-workspace-web/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/Hackend/vistas/reports/reportUsuarios.jasper")) {
